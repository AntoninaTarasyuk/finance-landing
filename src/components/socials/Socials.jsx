...
function SocialList({
  ...
  return (
    <ul className='socials-list'>
      <li>
        <a className='social-link' href={FB} target='_blank' rel='noopener noreferrer'>
      ...
      <li>
        <a className='social-link' href={TW} target='_blank' rel='noopener noreferrer'>
          <svg className='social-icon' width='35' height='35' viewBox='0 0 35 35' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      <li>
        <a className='social-link' href={YT} target='_blank' rel='noopener noreferrer'>
      ...
      <li>
        <a className='social-link' href={LI} target='_blank' rel='noopener noreferrer'>
